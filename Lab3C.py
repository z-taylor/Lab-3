...
print("You've entered "+ str(numSmall) +" small sandwiches.")
print("You've entered "+ str(numMed) +" medium sandwiches.")
print("You've entered "+ str(numLarge) +" large sandwiches.")
print("You've entered "+ str(numXlarge) +" extra-large sandwiches.")
